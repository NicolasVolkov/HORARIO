...
public class exercicio6 {
    ...
    public static int calcularPontos(int vit, int emp, int der) {
        int pontos = 0;
        int pv = vit * 3;
        int pe = emp * 1;
        int pd = der * 0;
    ...
    public static int calcularAproveitamento(int vit, int emp, int der, int part) {
        int porc = calcularPontos(vit, emp, der);
        int exp = part * 3;
        porc = (porc* 100)/exp;
        return (porc);
    }
